...
class MainWindow(QMainWindow):
    ...
    def _build_ui(self) -> None:
        ...
        top_bar_layout.setContentsMargins(28, 24, 28, 24)
        top_bar_layout.setSpacing(20)

        header = QVBoxLayout()
        header.setSpacing(8)
        badge = QLabel("Raspberry Pi 5 / YOLOv8 / Hailo-ready")
        badge.setObjectName("heroBadge")
        title = QLabel("果乾 Edge AI 控制台")
        title.setObjectName("titleLabel")
        subtitle = QLabel("從硬體控制、資料收集到本地推論的教學流程")
        ...
        content_layout.addWidget(self.hardware_panel)
        content_layout.addWidget(self.collection_panel)
        content_layout.addWidget(self.inference_panel)
        root_layout.addWidget(content, alignment=Qt.AlignmentFlag.AlignHCenter)
